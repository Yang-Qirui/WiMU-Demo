...
if __name__ == "__main__":
    ...
    ap_unions = process_all("data/JD_langfang/unlabeled")
    training_coors = process_waypoints(is_training=True, data_path="data/JD_langfang/train")
    testing_coors = process_waypoints(is_training=False, data_path="data/JD_langfang/test")
    ...
    process_directory_for_steps("data/JD_langfang/unlabeled", ap_unions, {"pos_range": training_pos_range.numpy(), "pos_min": training_pos_min.numpy()})
    end_time = time.time()
